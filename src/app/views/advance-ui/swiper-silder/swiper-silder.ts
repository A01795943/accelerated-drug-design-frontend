...
import { SwiperDirective } from "@/app/core/directive/swiper-directive";
...
@Component({
  ...
  standalone: true,
  imports: [SwiperDirective,UIExamplesList],
  templateUrl: './swiper-silder.html',
  schemas:[CUSTOM_ELEMENTS_SCHEMA],
  styles: ``
})
export class SwiperSilder {
title="Swiper"
